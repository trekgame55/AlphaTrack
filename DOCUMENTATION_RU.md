...
| GET | `/api/backup/{filename}/download` | Скачать бэкап |
| GET | `/api/backup/db/download` | Скачать текущую БД |
...
- Генерируется уникальный токен с ролью и workspace_id.
